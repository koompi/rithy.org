import { IconTemplate } from "../lib/index.js";
  ...
  export function WiMoonAltWaningCrescent2(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0-1.52.3-2.98.89-4.37s1.4-2.58 2.4-3.59 2.2-1.81 3.59-2.4 2.84-.89 4.37-.89 2.98.3 4.37.89 2.59 1.4 3.6 2.4 1.81 2.2 2.4 3.59.89 2.84.89 4.37-.3 2.98-.89 4.37-1.4 2.59-2.4 3.6-2.2 1.81-3.6 2.4-2.85.89-4.37.89-2.98-.3-4.37-.89-2.58-1.4-3.59-2.4-1.81-2.2-2.4-3.6-.89-2.84-.89-4.37zm1.2 0c0 1.36.26 2.65.79 3.89s1.24 2.3 2.12 3.2 1.95 1.62 3.17 2.15 2.52.81 3.87.82c-1.16-2.47-1.74-5.83-1.74-10.06 0-3.61.6-6.96 1.8-10.05-1.36 0-2.65.27-3.89.81s-2.3 1.25-3.19 2.15-1.61 1.97-2.14 3.2-.79 2.54-.79 3.89z"/>'
      }, props)
  }
  export function WiMoonAltWaningCrescent3(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0-1.52.3-2.98.89-4.37s1.4-2.58 2.4-3.59 2.2-1.81 3.59-2.4 2.84-.89 4.37-.89 2.98.3 4.37.89 2.59 1.4 3.6 2.4 1.81 2.2 2.4 3.59.89 2.84.89 4.37-.3 2.98-.89 4.37-1.4 2.59-2.4 3.6-2.2 1.81-3.6 2.4-2.85.89-4.37.89-2.98-.3-4.37-.89-2.58-1.4-3.59-2.4-1.81-2.2-2.4-3.6-.89-2.84-.89-4.37zm1.2 0c0 1.34.26 2.62.77 3.85s1.21 2.29 2.08 3.19 1.92 1.62 3.13 2.16 2.48.83 3.81.87c-1.71-2.32-2.56-5.68-2.56-10.06 0-1.87.23-3.67.69-5.41s1.11-3.29 1.95-4.64c-1.8.03-3.45.5-4.96 1.41s-2.7 2.13-3.58 3.65-1.33 3.19-1.33 4.98z"/>'
      }, props)
  }
  export function WiMoonAltWaningCrescent4(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0-1.52.3-2.98.89-4.37s1.4-2.58 2.4-3.59 2.2-1.81 3.59-2.4 2.84-.89 4.37-.89 2.98.3 4.37.89 2.59 1.4 3.6 2.4 1.81 2.2 2.4 3.59.89 2.84.89 4.37-.3 2.98-.89 4.37-1.4 2.59-2.4 3.6-2.2 1.81-3.6 2.4-2.85.89-4.37.89-2.98-.3-4.37-.89-2.58-1.4-3.59-2.4-1.81-2.2-2.4-3.6-.89-2.84-.89-4.37zm1.2 0c0 1.33.25 2.6.75 3.81s1.18 2.26 2.03 3.15 1.87 1.61 3.05 2.17 2.43.87 3.74.94c-1.24-1.19-2.11-2.63-2.61-4.31s-.75-3.6-.75-5.76c0-1.93.31-3.78.92-5.54s1.47-3.26 2.56-4.5c-1.77.07-3.39.56-4.88 1.47S7.09 8 6.23 9.51s-1.29 3.17-1.29 4.93z"/>'
      }, props)
  }
  export function WiMoonAltWaningCrescent5(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0-1.52.3-2.98.89-4.37s1.4-2.58 2.4-3.59 2.2-1.81 3.59-2.4 2.84-.89 4.37-.89 2.98.3 4.37.89 2.59 1.4 3.6 2.4 1.81 2.2 2.4 3.59.89 2.84.89 4.37-.3 2.98-.89 4.37-1.4 2.59-2.4 3.6-2.2 1.81-3.6 2.4-2.85.89-4.37.89-2.98-.3-4.37-.89-2.58-1.4-3.59-2.4-1.81-2.2-2.4-3.6-.89-2.84-.89-4.37zm1.2 0c0 1.27.23 2.49.7 3.66s1.09 2.2 1.89 3.08 1.75 1.61 2.85 2.19 2.28.94 3.52 1.08c-1.75-1.04-2.98-2.39-3.7-4.07s-1.08-3.66-1.08-5.93c0-2.07.44-4 1.32-5.78s2.1-3.2 3.66-4.24c-1.26.11-2.46.45-3.59 1.02s-2.1 1.3-2.92 2.19-1.46 1.92-1.93 3.11-.72 2.4-.72 3.69z"/>'
      }, props)
  }
  export function WiMoonAltWaningCrescent6(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0-1.52.3-2.98.89-4.37s1.4-2.58 2.4-3.59 2.2-1.81 3.59-2.4 2.84-.89 4.37-.89 2.98.3 4.37.89 2.59 1.4 3.6 2.4 1.81 2.2 2.4 3.59.89 2.84.89 4.37-.3 2.98-.89 4.37-1.4 2.59-2.4 3.6-2.2 1.81-3.6 2.4-2.85.89-4.37.89-2.98-.3-4.37-.89-2.58-1.4-3.59-2.4-1.81-2.2-2.4-3.6-.89-2.84-.89-4.37zm1.2 0c0 2.48.8 4.66 2.41 6.53s3.62 3.01 6.03 3.41c-1.01-.5-1.86-1.1-2.56-1.82s-1.25-1.5-1.63-2.37-.66-1.77-.83-2.7-.26-1.95-.26-3.06c0-2.11.5-4.06 1.49-5.84s2.37-3.16 4.12-4.12c-1.63.21-3.11.77-4.45 1.7S6.87 8.3 6.1 9.76s-1.16 3.01-1.16 4.68z"/>'
      }, props)
  }
  export function WiMoonAltWaningGibbous1(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.43c0-2.04.51-3.92 1.52-5.65S7.64 5.7 9.37 4.69s3.61-1.5 5.65-1.5 3.92.5 5.65 1.5 3.09 2.36 4.09 4.09 1.5 3.61 1.5 5.65-.5 3.93-1.5 5.65-2.36 3.1-4.09 4.11-3.61 1.52-5.65 1.52-3.93-.51-5.65-1.52-3.1-2.38-4.11-4.11-1.52-3.61-1.52-5.65zm1.2 0c0 1.36.27 2.66.81 3.9S7 20.65 7.9 21.55s1.97 1.62 3.22 2.15 2.55.81 3.9.81c.86 0 1.62-.09 2.29-.28.83-.44 1.55-.96 2.17-1.57s1.1-1.22 1.46-1.85.64-1.33.86-2.09.36-1.48.43-2.14.1-1.37.1-2.15c0-.93-.1-1.84-.3-2.74s-.51-1.79-.93-2.67-.99-1.72-1.72-2.5-1.57-1.45-2.54-1.99c-.4-.09-1.01-.13-1.82-.13-1.36 0-2.66.26-3.9.79S8.8 6.43 7.9 7.32s-1.62 1.97-2.15 3.2-.81 2.54-.81 3.91z"/>'
      }, props)
  }
  ...
  export function WiMoonThirdQuarter(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0 2.04.5 3.93 1.51 5.65s2.37 3.1 4.09 4.1 3.61 1.51 5.65 1.51V3.19c-2.04 0-3.92.5-5.65 1.51S6.26 7.07 5.25 8.8s-1.51 3.6-1.51 5.64z"/>'
      }, props)
  }
  export function WiMoonWaningCrescent1(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0 2.04.5 3.93 1.51 5.65s2.37 3.1 4.09 4.1 3.61 1.51 5.65 1.51c-1-3.14-1.49-6.9-1.49-11.26 0-3.43.5-7.18 1.49-11.25-2.04 0-3.92.5-5.65 1.51S6.26 7.07 5.25 8.8s-1.51 3.6-1.51 5.64z"/>'
      }, props)
  }
  export function WiMoonWaningCrescent2(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0 2.04.5 3.93 1.51 5.65s2.37 3.1 4.1 4.1S12.96 25.7 15 25.7c-2.01-2.74-3.02-6.5-3.02-11.26 0-3.98 1.01-7.73 3.02-11.25-2.04 0-3.93.5-5.65 1.51s-3.1 2.37-4.1 4.09-1.51 3.61-1.51 5.65z"/>'
      }, props)
  }
  export function WiMoonWaningCrescent3(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0 2.04.5 3.93 1.51 5.65s2.37 3.1 4.09 4.1 3.61 1.51 5.65 1.51c-2.99-2.33-4.48-6.09-4.48-11.26 0-2.32.42-4.46 1.25-6.4s1.91-3.56 3.23-4.85c-2.04 0-3.92.5-5.65 1.51S6.26 7.07 5.25 8.8s-1.51 3.6-1.51 5.64z"/>'
      }, props)
  }
  export function WiMoonWaningCrescent4(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0 2.04.5 3.93 1.51 5.65s2.37 3.1 4.1 4.1S12.96 25.7 15 25.7c-2.07-1.01-3.59-2.45-4.56-4.33S9 17.19 9 14.44c0-2.53.56-4.78 1.69-6.75s2.57-3.47 4.31-4.5c-2.04 0-3.93.5-5.65 1.51s-3.1 2.37-4.1 4.09-1.51 3.61-1.51 5.65z"/>'
      }, props)
  }
  export function WiMoonWaningCrescent5(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0 2.04.5 3.93 1.51 5.65s2.37 3.1 4.09 4.1 3.61 1.51 5.65 1.51c-2.59-.79-4.48-2.13-5.69-4.02s-1.81-4.3-1.81-7.24c0-1.39.2-2.7.6-3.95.4-1.25.94-2.34 1.63-3.27s1.48-1.75 2.37-2.44 1.86-1.22 2.89-1.59c-2.04 0-3.92.5-5.65 1.51S6.26 7.07 5.25 8.8s-1.51 3.6-1.51 5.64z"/>'
      }, props)
  }
  export function WiMoonWaningCrescent6(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.44c0 2.04.5 3.93 1.51 5.65s2.37 3.1 4.09 4.1 3.61 1.51 5.65 1.51c-1.46-.56-2.72-1.18-3.79-1.88s-1.93-1.39-2.57-2.1-1.15-1.49-1.53-2.34-.64-1.66-.77-2.42-.2-1.6-.2-2.52c0-.65.03-1.26.08-1.81s.16-1.14.32-1.77.38-1.21.64-1.75.63-1.09 1.08-1.66.98-1.1 1.59-1.57 1.34-.95 2.21-1.42 1.85-.89 2.93-1.27c-2.04 0-3.92.5-5.65 1.51S6.26 7.07 5.25 8.8s-1.51 3.6-1.51 5.64z"/>'
      }, props)
  }
  export function WiMoonWaningGibbous1(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.49c0 1.22.19 2.4.56 3.54s.91 2.17 1.6 3.09 1.5 1.72 2.42 2.42 1.95 1.23 3.09 1.6 2.32.56 3.54.56c5.03-1.4 7.54-5.14 7.54-11.22 0-1.18-.14-2.3-.42-3.37s-.65-2.01-1.13-2.83-1.04-1.57-1.68-2.24-1.34-1.24-2.06-1.68-1.47-.81-2.26-1.07c-1.52 0-2.98.3-4.37.89S8.02 5.57 7.02 6.57s-1.8 2.19-2.39 3.57-.89 2.83-.89 4.35z"/>'
      }, props)
  }
  export function WiMoonWaningGibbous2(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.49c0 1.22.19 2.4.56 3.54s.91 2.17 1.6 3.09 1.5 1.72 2.42 2.42 1.95 1.23 3.09 1.6 2.32.56 3.54.56c4.33-1.73 6.49-5.47 6.49-11.22 0-1.39-.18-2.7-.54-3.93s-.85-2.31-1.47-3.23-1.31-1.71-2.06-2.39-1.56-1.23-2.42-1.66c-2.03 0-3.91.5-5.63 1.5S6.25 7.14 5.24 8.86s-1.5 3.6-1.5 5.63z"/>'
      }, props)
  }
  export function WiMoonWaningGibbous3(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.49c0 1.22.19 2.4.56 3.54s.91 2.17 1.6 3.09 1.5 1.72 2.42 2.42 1.95 1.23 3.09 1.6 2.32.56 3.54.56c3.61-2.07 5.42-5.81 5.42-11.22 0-1.31-.15-2.56-.45-3.74s-.71-2.24-1.23-3.17-1.1-1.75-1.72-2.46-1.3-1.33-2.02-1.86c-1.52 0-2.98.3-4.37.89S8 5.53 7 6.54s-1.8 2.2-2.39 3.59-.87 2.83-.87 4.36z"/>'
      }, props)
  }
  export function WiMoonWaningGibbous4(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.47c0 1.52.3 2.98.89 4.37s1.39 2.58 2.4 3.59 2.2 1.8 3.59 2.4 2.84.89 4.37.89c2.89-2.39 4.34-6.14 4.34-11.24 0-2.34-.41-4.47-1.22-6.36S16.26 4.6 15 3.25c-2.03 0-3.91.5-5.64 1.51S6.25 7.12 5.24 8.84s-1.5 3.6-1.5 5.63z"/>'
      }, props)
  }
  export function WiMoonWaningGibbous5(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.47c0 2.03.5 3.91 1.51 5.63s2.37 3.09 4.09 4.09 3.6 1.51 5.63 1.51c2.17-2.75 3.25-6.5 3.25-11.24 0-3.96-1.08-7.71-3.25-11.24-2.03 0-3.91.5-5.63 1.5S6.26 7.1 5.25 8.83s-1.51 3.61-1.51 5.64z"/>'
      }, props)
  }
  export function WiMoonWaningGibbous6(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.46c0 2.04.5 3.92 1.51 5.65s2.37 3.09 4.09 4.09 3.61 1.51 5.65 1.51c1.44-3.08 2.15-6.83 2.15-11.25 0-3.46-.72-7.2-2.15-11.24-1.52 0-2.98.3-4.37.89S8.03 5.5 7.03 6.5s-1.8 2.2-2.4 3.59-.89 2.84-.89 4.37z"/>'
      }, props)
  }
  export function WiMoonWaxing6(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M14.99 25.71c2.04 0 3.93-.5 5.65-1.51s3.1-2.37 4.1-4.1 1.51-3.61 1.51-5.65-.5-3.92-1.51-5.65-2.37-3.09-4.1-4.09-3.61-1.51-5.65-1.51c1.67 2.9 2.5 6.65 2.5 11.25 0 2.33-.17 4.43-.52 6.3s-1 3.51-1.98 4.96z"/>'
      }, props)
  }
  export function WiMoonWaxingCrescent1(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M15.01 25.71c2.04 0 3.92-.5 5.65-1.51s3.09-2.37 4.09-4.1 1.51-3.61 1.51-5.65-.5-3.92-1.51-5.65-2.37-3.09-4.09-4.09-3.61-1.51-5.65-1.51c1.32.52 2.48 1.2 3.47 2.06s1.78 1.79 2.35 2.82.99 2.07 1.27 3.13.41 2.14.41 3.24c0 .64-.02 1.26-.07 1.84-.05.58-.15 1.2-.29 1.87s-.33 1.28-.56 1.86-.54 1.15-.92 1.74-.83 1.11-1.35 1.58-1.14.92-1.87 1.33-1.55.75-2.44 1.04z"/>'
      }, props)
  }
  export function WiMoonWaxingCrescent2(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M15.01 25.71c2.04 0 3.92-.5 5.65-1.51s3.09-2.37 4.09-4.1 1.51-3.61 1.51-5.65-.5-3.92-1.51-5.65-2.37-3.09-4.09-4.09-3.61-1.51-5.65-1.51c1.1.59 2.07 1.32 2.89 2.19s1.47 1.82 1.95 2.83.83 2.03 1.05 3.07.34 2.09.34 3.16c0 .91-.04 1.76-.13 2.54s-.27 1.63-.53 2.53-.62 1.71-1.06 2.43-1.04 1.42-1.82 2.09-1.67 1.22-2.69 1.67z"/>'
      }, props)
  }
  export function WiMoonWaxingCrescent3(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M15.01 25.71c2.04 0 3.92-.5 5.65-1.51s3.09-2.37 4.09-4.1 1.51-3.61 1.51-5.65-.5-3.92-1.51-5.65-2.37-3.09-4.09-4.09-3.61-1.51-5.65-1.51c1.71 1.26 2.97 2.9 3.78 4.91S20 12.24 20 14.44c0 .9-.03 1.73-.1 2.5s-.21 1.59-.43 2.47-.51 1.68-.86 2.4-.83 1.42-1.45 2.12-1.33 1.28-2.15 1.78z"/>'
      }, props)
  }
  export function WiMoonWaxingCrescent4(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M15.01 25.71c2.04 0 3.92-.5 5.65-1.51s3.09-2.37 4.09-4.1 1.51-3.61 1.51-5.65-.5-3.92-1.51-5.65-2.37-3.09-4.09-4.09-3.61-1.51-5.65-1.51c1.29 1.39 2.24 3.07 2.84 5.05s.91 4.05.91 6.2c0 .88-.03 1.69-.08 2.44s-.16 1.55-.32 2.41-.38 1.65-.64 2.37-.63 1.43-1.09 2.15-1.01 1.33-1.62 1.89z"/>'
      }, props)
  }
  ...
  export function WiTime6(props) {
      return IconTemplate({
        a: {"xml:space":"preserve","id":"Layer_1","x":"0","y":"0","enable-background":"new 0 0 30 30","version":"1.1","viewBox":"0 0 30 30"},
        c: '<path d="M3.74 14.47c0-2.04.51-3.93 1.52-5.66s2.38-3.1 4.11-4.11 3.61-1.51 5.64-1.51c1.52 0 2.98.3 4.37.89s2.58 1.4 3.59 2.4 1.81 2.2 2.4 3.6.89 2.85.89 4.39c0 1.52-.3 2.98-.89 4.37s-1.4 2.59-2.4 3.59-2.2 1.8-3.59 2.39-2.84.89-4.37.89c-1.53 0-3-.3-4.39-.89s-2.59-1.4-3.6-2.4-1.8-2.2-2.4-3.58-.88-2.84-.88-4.37zm2.48 0c0 2.37.86 4.43 2.59 6.18 1.73 1.73 3.79 2.59 6.2 2.59 1.58 0 3.05-.39 4.39-1.18s2.42-1.85 3.21-3.2 1.19-2.81 1.19-4.39-.4-3.05-1.19-4.4-1.86-2.42-3.21-3.21-2.81-1.18-4.39-1.18-3.05.39-4.39 1.18S8.2 8.72 7.4 10.07s-1.18 2.82-1.18 4.4zm7.92 4.6V7.81c0-.23.08-.43.24-.59s.36-.24.59-.24.43.08.59.24.24.36.24.59v11.26c0 .23-.08.43-.24.6s-.36.25-.59.25-.43-.08-.59-.25-.24-.36-.24-.6z"/>'
      }, props)
  }

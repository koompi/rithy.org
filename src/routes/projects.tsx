    ...
    <section class="w-full">
      <div class="py-12 " data-aos="fade-up">
        <div class="grid gap-4 mx-4 sm:grid-cols-12">
          <div class="col-span-12 sm:col-span-0 lg:col-span-3 ">
          ...
          <div class="relative col-span-12 px-0 md:px-0 lg:px-4 space-y-6 sm:col-span-12 lg:col-span-9 ml-0 sm:ml-9 lg:ml-0">
                ...
                {(res) => (
                  <Show when={res} fallback={<p>Loading ...</p>}>
                    <div class="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-indigo-400">
                      ...
                      <p class="mt-3 text-md sm:text-4xl lg:text-xl my-leading-none sm:my-leading lg:my-leading-none">
                        {res?.desc}
                      </p>
                    </div>
                  </Show>
